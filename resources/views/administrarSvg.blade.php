    ...
    <div class="content-wrapper">
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <div class="small-box bg-yellow">
                                <a href="javascript:history.back()" class="small-box-footer">Atrás <i class="fa fa-arrow-circle-left"></i></a>
                            </div>
                            </div>
                            <div class="row">
                                <div class="col-md-8" >
       ...
       1747.2,752.8 1798.1,587.4 1726.8,551.9 1638.7,550.4 1611.6,556.9 		" />
                                ...
                                <div class="col-md-4">
                                    ...
                                    <label for="ciudad" class="col-sm-4 control-label">ID</label>
                                    <div class="col-sm-4">
                                    <input type="text" class="form-control" id="ciudad" placeholder="id">
                                    </div>
                                    </div>
                                    <br><br>
                                    <div class="form-group">
                                    <label for="ciudad" class="col-sm-4 control-label">Imagen</label>
                                    <div class="col-sm-4">
                                    <input type="text" class="form-control" id="ciudad" placeholder="imagen">
                                    </div>
                                    </div>
                                    <br><br>
                                    <div class="form-group">
                                    <label for="ciudad" class="col-sm-4 control-label">Tamaño m²</label>
                                    <div class="col-sm-4">
                                    <input type="text" class="form-control" id="ciudad" placeholder="m²">
                                    </div>
                                    </div>
                                    <br><br>
                                    <div class="form-group">
                                    <label for="ciudad" class="col-sm-4 control-label">Información</label>
                                    <div class="col-sm-4">
                                    <input type="text" class="form-control" id="ciudad" placeholder="m²">
                                    </div>
                                    </div>
                                    <br><br>
                                    <div class="form-group">
                                    <label for="ciudad" class="col-sm-4 control-label">Agua</label>
                                    <div>
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    <input type="checkbox">
                                    </div>
                                    ...
                                    <br>
                                    <div class="form-group">
                                    <label for="ciudad" class="col-sm-4 control-label">Alcantarillado</label>
                                    <div>
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    <input type="checkbox">
                                    </div>
                                    ...
                                    <br>
                                    <div class="form-group">
                                    <label for="ciudad" class="col-sm-4 control-label">Electricidad</label>
                                    <div>
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    <input type="checkbox">
                                    </div>
                                    ...
                                    <br>
                                    <div class="form-group">
                                    <label for="ciudad" class="col-sm-4 control-label">Gas Natural</label>
                                    <div>
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    <input type="checkbox">
                                    </div>
                                    ...
                                    <br>
                                    <div class="form-group">
                                    <label for="ciudad" class="col-sm-4 control-label">Cobertura Línea</label>
                                    <div>
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    <input type="checkbox">
                                    </div>
                                    ...
                                    <label for="ciudad" class="col-sm-4 control-label">Amurallado</label>
                                    <div>
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    <input type="checkbox">
                                    </div>
                                    ...
                                    <td>
                                    <div>
                                    <a href="#reservar" class="btn btn-primary btn-block" data-toggle="modal">Guardar</a>
                                    <div class="modal fade" id="reservar" tabindex="-1" role="dialog" aria-labelledby="reservarTitle" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered" style="background-color: #E5E8E8;" role="document">
                                            <div class="model-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="reservarLongTitle">Alerta</h5>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span></button>
                                                </div>

                                                <div class="modal-body">
                                                    <h3>Seguro desea guardar la información?</h3>
                                                </div>

                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
                                                    <a href="svg"><button type="button" class="btn btn-primary">Guardar</button></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
