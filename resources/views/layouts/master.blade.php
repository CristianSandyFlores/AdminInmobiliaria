...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('frontend') }}/bower_components/bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css">
...
<!-- InputMask -->
<script src="{{ asset('frontend') }}/plugins/input-mask/jquery.inputmask.js"></script>
<script src="{{ asset('frontend') }}/plugins/input-mask/jquery.inputmask.date.extensions.js"></script>
